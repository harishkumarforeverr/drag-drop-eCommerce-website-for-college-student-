                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <a href="link"><strong><span className="mdi mdi-home" /> Home</strong></a> <span className="mdi mdi-chevron-right" /> <a href="link">Fruits &amp; Vegetables</a> <span className="mdi mdi-chevron-right" /> <a href="link">Fruits</a>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-9">
                                <div className="shop-head">
                                    <a href="link"><span className="mdi mdi-home" /> Home</a> <span className="mdi mdi-chevron-right" /> <a href="link">Fruits &amp; Vegetables</a> <span className="mdi mdi-chevron-right" /> <a href="link">Fruits</a>
                                    <div className="btn-group float-right mt-2">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-right">
                                            <a className="dropdown-item" href="link">Relevance</a>
                                            <a className="dropdown-item" href="link">Price (Low to High)</a>
                                            <a className="dropdown-item" href="link">Price (High to Low)</a>
                                            <a className="dropdown-item" href="link">Discount (High to Low)</a>
                                            <a className="dropdown-item" href="link">Name (A to Z)</a>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div className="product">
                                                                        <Link to={{
                                                                            ...
                                                                            <div className="product-header">
                                                                                ...
                                                                                <div>{this.state.productText}</div>
